 ...
 *
 * Copyright (C) 2011-2024 Fernando Gont
 *
...
int main(int argc, char **argv) {
    ...
    const char shortopts[] = "i:s:d:A:u:U:H:y:S:D:eE:r:t:p:P:nc:x:o:a:X:q:Q:V:w:MONj:k:J:K:b:g:B:G:fR:T:F:lz:Lvh";
...
void print_attack_info(struct iface_data *idata) {
    ...
    if (rhicmp6_f && idata->dstaddr_f) {
        ...
        printf("Identifier: %u%s\tSequence Number: %u%s", icmp6id, (icmp6id_f ? "" : " (randomized)"), icmp6seq,
