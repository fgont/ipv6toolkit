...
unsigned int		ip6hoplimit_f=0, ip6length_f=0;
unsigned int		ackdata_f=1, ackflags_f=1;

/* Variables used for ICMPv6 Redirect (specifically) */

u_int16_t			ip6length;
u_int16_t			srcport, dstport, tcpurg, tcpwin, icmp6id, icmp6seq;
...
unsigned char		srcprefix_f=0, hoplimit_f=0;
unsigned char		floods_f=0, floodp_f=0;
...
int main(int argc, char **argv){
	...
	char shortopts[]= "i:s:d:A:u:U:H:y:S:D:P:c:o:a:X:q:Q:V:w:Nfj:k:J:K:b:g:B:G:F:T:lz:Lvh";
